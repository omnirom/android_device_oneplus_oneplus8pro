...
public class Startup extends BroadcastReceiver {
    ...
    private static final boolean sIsOnePlus8 = android.os.Build.DEVICE.equals("OnePlus8");
    ...
    private void maybeImportOldSettings(Context context) {
        ...
        if (!imported) {
            ...
            Settings.System.putFloat(context.getContentResolver(), Settings.System.PEAK_REFRESH_RATE, enabled ? 120f : 60f);
